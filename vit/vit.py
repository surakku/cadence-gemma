...
class PatchEmbed(nn.Module):
    """Split image into patches then embed those patches.
...
class Attention(nn.Module):
    ...
    def forward(self, x):
        ...
        assert dim == self.dim, "Dimension mismatch error."
...
class Block(nn.Module):
    ...
    qkv_bias: bool
        If true, include bias to the query, key and value projections.
...
class VisionTransformer(nn.Module):
    ...
    patch_size: int
        Both height and width of a patch (square).
    ...
    qkv_bias: bool
        If true, include bias to key, query and value projections.
    ...
    pos_emb: nn.Parameter
        ...
        It has (n_patches + 1) * embed dim elements.
